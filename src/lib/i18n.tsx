...
const DICTIONARIES: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    "events.town_calendar": "Town Calendar",
    "events.subtitle": "Town meetings, library programs, school events, and community happenings",
    ...
    "chat.share": "Share",
    "chat.copied": "Copied!",
    "chat.suggested_questions": "Related questions",
  ...
  es: {
    ...
    "header.permits": "Permisos y Zonificación",
    ...
    "events.no_events": "No hay eventos proximos",
    "events.view_details": "Ver Detalles",
    "events.town_calendar": "Calendario Municipal",
    "events.subtitle": "Reuniones municipales, programas de biblioteca, eventos escolares y actividades comunitarias",
    ...
    "chat.new_chat": "Nueva conversacion",
    "chat.share": "Compartir",
    "chat.copied": "Copiado!",
    "chat.suggested_questions": "Preguntas relacionadas",
    "chat.no_history": "Sin conversaciones previas",
    "chat.delete_conversation": "Eliminar conversacion",
  ...
  zh: {
    ...
    "events.no_events": "暂无即将举行的活动",
    "events.view_details": "查看详情",
    "events.town_calendar": "市镇日历",
    "events.subtitle": "市政会议、图书馆项目、学校活动和社区活动",
    ...
    "chat.share": "分享",
    "chat.copied": "已复制！",
    "chat.suggested_questions": "相关问题",
    "chat.no_history": "没有历史对话",
