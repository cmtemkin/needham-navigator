...
export function LifeSituationTile({ tile }: LifeSituationTileProps) {
  ...
  return (
    <div
      ...
      className="bg-white border border-border-light rounded-xl p-[22px_20px_18px] cursor-pointer transition-all hover:border-primary hover:shadow-md hover:-translate-y-0.5 relative overflow-hidden group"
    >
      <div
      ...
      <div className="flex flex-col gap-[5px]">
        {tile.subPrompts.map((prompt) => (
          <button
            ...
            className="flex items-center gap-1.5 text-xs text-primary font-medium px-2 py-[5px] rounded-md hover:bg-[#EBF0F8] transition-colors text-left group/prompt"
          >
